...
public class StorageService {
    ...
    private void dataStorage() {
        ...
        Searchable bread = new SimpleProduct(45, "хлеб");
        ...
        addToProductMap(bread,caviar, toothStick, eggs, celery, sauerkraut, AI, PC, GlobalWarming, Neuroplasticity, Blockchain, GeneticEngineering, Story);
    }

    public Collection<Searchable> getAllStorageValue() {
        List<Searchable> searchableList = new ArrayList<>();
        searchableList.addAll(getAllProductValue());
        searchableList.addAll(getAllArticleValue());
